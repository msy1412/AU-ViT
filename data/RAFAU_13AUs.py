...
def load_imgs(txt_label,img_folder_path,insert_index):
    ...
    with open(txt_label, 'r') as imf:
        for line in imf:
            ...
            img_name = line[0]
            label_arr = line[1:]
            label_= label_arr[0:5]+label_arr[6:9]
            label_.extend([label_arr[10],label_arr[12],label_arr[14]])
            # label_.append(label_arr[10])
            # label_.append(label_arr[12])
            # label_.append(label_arr[14])
            label_+=label_arr[18:20]
            label_arr=label_
